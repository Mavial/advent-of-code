...
class DataLoader:
    def __init__(self, day: int, year: int = 2022) -> None:
        ...
        if session_cookie == None:
            exit("No session cookie found. Please set the SESSION environment variable to your adventofcode.com session cookie.")
    ...
    def load(self):
        ...
        data = requests.get( f"https://adventofcode.com/{self.year}/day/{self.day}/input", cookies=self.cookies ).text[:-1]
